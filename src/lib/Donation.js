// Shared utilities for FoodBridge donations + 80G certificates
// All persistence is in localStorage (front-end only for now)
...
// Estimate ₹ value per meal — used for 80G certificate "amount received"
